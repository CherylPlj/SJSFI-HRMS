      ...
      <div className="flex min-h-screen">
        ...
        <div className="w-1/2 bg-white flex flex-col items-center justify-start p-8 mt-10 ">
          <img
            ...
            src="/sjsfilogo.png"
          />
          <h1 className="text-4xl md:text-4xl text-center font-bold text-[#800000] mb-2 p-10">
          ...
          <div className="flex flex-col items-center space-y-6">
            <button
                ...
                className="w-[680px] md:w-[480px] py-3 border-2 border-[#800000] text-[#800000] rounded-full text-lg md:text-xl transition-all duration-300 hover:bg-[#800000] hover:text-white hover:font-semibold"
            >
                Faculty
            </button>
            <button
